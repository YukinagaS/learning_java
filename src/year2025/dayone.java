...
public class dayone {
  ...
  static void turnDial(ArrayList<String> data) {
    ...
    for(String item : data) {
      ...
      int extraRevs = fullSpin / 100 % 100;

      String message = String.format("Direction: %s, Distance: %s, Revs: %s", direction, distance, extraRevs);
      ...
      if (direction == 'L') {
        ...
        if (distance >= dialPosition) zeroCount += 1; //P2
